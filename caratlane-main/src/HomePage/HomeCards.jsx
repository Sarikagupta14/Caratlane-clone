...
<Box  w="90%" m="auto" >
      <Flex w="100%" >
        ...
        <Image h="200px"  src="https://github.com/shwetra/assa/assets/104376252/d47bcb2f-1b53-4095-898f-e29ba52be8da" alt="Image 1"   />
        <Box mr="10px" mt="40px">
        ...
        <Flex w='50%' direction={{base:"column",md:"column",lg:"row"}}>
        <Image h="200px" src="https://github.com/shwetra/assa/assets/104376252/8301b2b8-9ba9-4967-bd33-9593abbb4275" alt=""   />
      ...
      <Flex    direction={{base:"column",md:"column",lg:"row"}}>
        <Image h="200px"  src="https://github.com/shwetra/assa/assets/104376252/7ecde2fb-b3ca-46ee-a33b-b554c516413f" alt="Image 1"  />
        ...
        <Flex direction={{base:"column",md:"column",lg:"row"}}>
        <Image h="200px" src="https://github.com/shwetra/assa/assets/104376252/a620ab71-dcb6-4d73-ba23-945aea35b22b" alt="" />
